  ...
  <div id="app" :class="$style.app">
    ...
    <vue-sidebar>
      ...
      <vue-sidebar-group title="Community">
        <vue-sidebar-group-item>
          <a href="https://github.com/camscoderepo" target="_blank" rel="noopener">
            <vue-icon-github />
            Github
          </a>
        </vue-sidebar-group-item>
        ...
        <vue-sidebar-group-item>
          <a href="" target="_blank" rel="noopener"> Slack </a>
        </vue-sidebar-group-item>

        <vue-sidebar-group-item>
          <a href="https://repl.it/@codebender" target="_blank" rel="noopener"> Repl.it </a>
        </vue-sidebar-group-item>
